...
public class SaleDetailActivity extends Activity {
    ...
    public static final String EXTRA_SALENO = "saleNo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int pizzaNo = (Integer) getIntent().getExtras().get(EXTRA_SALENO);
        String pizzaName = Sale.Sales[pizzaNo].getName();
        TextView textView = (TextView) findViewById(R.id.pizza_text);
        textView.setText(pizzaName);
        int pizzaImage = Sale.Sales[pizzaNo].getImageResourceId();
